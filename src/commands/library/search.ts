...
export default class LibrarySearch extends BaseCommand {
  ...
  static override summary = "Search the public library site";
  static override description = "Search public library guides. No Canvas token is sent; requests still use the shared human-paced limiter.";
  ...
  async run(): Promise<unknown> {
    ...
    const results = await library.search(args.query);
