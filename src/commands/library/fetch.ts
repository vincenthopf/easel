...
export default class LibraryFetch extends BaseCommand {
  ...
  static override description = "Fetch a public HTTPS page without a Canvas token. Use --objective, --full, or -o for a new output file.";
  static override examples = [
    "<%= config.bin %> library fetch https://library.example.edu/guide",
  ...
  static override args = { url: Args.string({ description: "library URL", required: true }) };
